...
export const softglazeApi = {
  ...
  proxies: {
    ...
    vendorLookup: (payload) => getSoftglazeApi().proxies.vendorLookup(payload),
    checkStream: (payload) => getSoftglazeApi().proxies.checkStream(payload),
    stopCheck: (payload) => getSoftglazeApi().proxies.stopCheck(payload),
    onCheckProgress: (cb) => getSoftglazeApi().proxies.onCheckProgress(cb),
  ...
  profiles: {
    ...
    grantAccess: (payload) => getSoftglazeApi().profiles.grantAccess(payload),
    revokeAccess: (payload) => getSoftglazeApi().profiles.revokeAccess(payload),
    listAccess: (profileId) => getSoftglazeApi().profiles.listAccess(profileId),
  ...
  license: {
    ...
    backendInfo: () => getSoftglazeApi().license.backendInfo(),
