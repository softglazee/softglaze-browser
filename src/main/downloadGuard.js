...
const HOSTS = {
  ...
  // Releases. The API returns the asset URL on github.com, which 302-redirects to
  // *.githubusercontent.com — both must be allowlisted so the redirect isn't rejected.
