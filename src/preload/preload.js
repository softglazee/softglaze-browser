...
const CHANNELS = Object.freeze({
  ...
  AUTOMATION_LIST_WARMERS: 'automation:list-warmers',
...
const api = Object.freeze({
  ...
  proxies: Object.freeze({
    ...
    vendorLookup: (payload) => invoke(CHANNELS.PROXY_VENDOR_LOOKUP, payload),
    ...
    recentHealth: (opts) => invoke(CHANNELS.PROXY_RECENT_HEALTH, opts || {})
  }),
  ...
  automation: Object.freeze({
    ...
    listActiveWarmers: () => invoke(CHANNELS.AUTOMATION_LIST_WARMERS),
